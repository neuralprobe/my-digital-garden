---
title: SystemC 41 Interrupt a thread while busy - template class
date: 2024-03-01
tags:
  - systemC
  - Cplusplus
...
With the provided `BufferTrigger_t` class, a child class can be derived from it, and implements the `task_handler()`, and `interrupt_handler()` function.
